...
public class ApiBlogService extends BaseService<Blog> {
    ...
    public List<BlogListVo> list(String tab, Integer page, Integer size) {
        ...
        for (Blog blog : list) {
            ...
            blogListVo.setAuthorId(1);
            blogListVo.setContent(blog.getContent());
            blogListVo.setCreateAt(blog.getCreateAt());
            blogListVo.setGood(true);
            blogListVo.setId(blog.getId());
            blogListVo.setLastReplyAt(blog.getUpdateAt());
            ...
            blogListVo.setVisitCount(blog.getClickCount());
            blogListVo.setReplyCount(0);
    ...
    public BlogListVo detail(Integer id) {
        ...
        //继承父类
        blogDetailVo.setAuthorId(1);
        blogDetailVo.setContent(blog.getContent());
        blogDetailVo.setCreateAt(blog.getCreateAt());
        blogDetailVo.setGood(true);
        blogDetailVo.setId(blog.getId());
        blogDetailVo.setLastReplyAt(blog.getUpdateAt());
        ...
        blogDetailVo.setVisitCount(blog.getClickCount());
        blogDetailVo.setReplyCount(0);
