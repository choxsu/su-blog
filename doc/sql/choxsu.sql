...
-- ----------------------------
INSERT INTO `permission` VALUES (161, '/admin', 'com.choxsu.admin.index.IndexAdminController', '后台首页');
INSERT INTO `permission` VALUES (162, '/admin/account', 'com.choxsu.admin.account.AccountAdminController', '账户首页');
INSERT INTO `permission` VALUES (163, '/admin/account/add', 'com.choxsu.admin.account.AccountAdminController', '账户添加页面');
INSERT INTO `permission` VALUES (164, '/admin/account/addRole', 'com.choxsu.admin.account.AccountAdminController', '账户角色添加');
INSERT INTO `permission` VALUES (165, '/admin/account/assignRoles', 'com.choxsu.admin.account.AccountAdminController', '账户分配角色页面');
INSERT INTO `permission` VALUES (166, '/admin/account/del', 'com.choxsu.admin.account.AccountAdminController', '账户删除');
INSERT INTO `permission` VALUES (167, '/admin/account/delTemFile', 'com.choxsu.admin.account.AccountAdminController', '删除存放临时目录的图片文件');
INSERT INTO `permission` VALUES (168, '/admin/account/deleteRole', 'com.choxsu.admin.account.AccountAdminController', '账户角色删除');
INSERT INTO `permission` VALUES (169, '/admin/account/edit', 'com.choxsu.admin.account.AccountAdminController', '账户编辑页面');
INSERT INTO `permission` VALUES (170, '/admin/account/lock', 'com.choxsu.admin.account.AccountAdminController', '账户锁定');
INSERT INTO `permission` VALUES (171, '/admin/account/save', 'com.choxsu.admin.account.AccountAdminController', '账户保存');
INSERT INTO `permission` VALUES (172, '/admin/account/saveAvatar', 'com.choxsu.admin.account.AccountAdminController', '账户头像保存');
INSERT INTO `permission` VALUES (173, '/admin/account/showAdminList', 'com.choxsu.admin.account.AccountAdminController', '显示后台管理员账户首页');
INSERT INTO `permission` VALUES (174, '/admin/account/unlock', 'com.choxsu.admin.account.AccountAdminController', '账户解锁');
INSERT INTO `permission` VALUES (175, '/admin/account/update', 'com.choxsu.admin.account.AccountAdminController', '账户更新');
INSERT INTO `permission` VALUES (176, '/admin/account/uploadAvatar', 'com.choxsu.admin.account.AccountAdminController', '账户头像裁剪');
INSERT INTO `permission` VALUES (177, '/admin/blog', 'com.choxsu.admin.blog.AdminBlogController', '文章首页');
INSERT INTO `permission` VALUES (178, '/admin/blog/add', 'com.choxsu.admin.blog.AdminBlogController', '文章添加页面');
INSERT INTO `permission` VALUES (179, '/admin/blog/allowComments', 'com.choxsu.admin.blog.AdminBlogController', '开启评论');
INSERT INTO `permission` VALUES (180, '/admin/blog/delete', 'com.choxsu.admin.blog.AdminBlogController', '文章删除');
INSERT INTO `permission` VALUES (181, '/admin/blog/edit', 'com.choxsu.admin.blog.AdminBlogController', '文章编辑页面');
INSERT INTO `permission` VALUES (182, '/admin/blog/oneKeyAllowComments', 'com.choxsu.admin.blog.AdminBlogController', '一键开启评论');
INSERT INTO `permission` VALUES (183, '/admin/blog/save', 'com.choxsu.admin.blog.AdminBlogController', '文章保存');
INSERT INTO `permission` VALUES (184, '/admin/blog/unAllowComments', 'com.choxsu.admin.blog.AdminBlogController', '关闭评论');
INSERT INTO `permission` VALUES (185, '/admin/blog/update', 'com.choxsu.admin.blog.AdminBlogController', '文章更新');
INSERT INTO `permission` VALUES (186, '/admin/code', 'com.choxsu.admin.code.CodeController', NULL);
INSERT INTO `permission` VALUES (187, '/admin/codeConfig', 'com.choxsu.admin.code.CodeConfigController', NULL);
INSERT INTO `permission` VALUES (188, '/admin/druid', 'com.choxsu.admin.druid.DruidController', 'Druid管理首页');
INSERT INTO `permission` VALUES (189, '/admin/loginLog', 'com.choxsu.admin.account.AccountAdminController', '账户登录日志首页');
INSERT INTO `permission` VALUES (190, '/admin/permission', 'com.choxsu.admin.permission.PermissionAdminController', '权限首页');
INSERT INTO `permission` VALUES (191, '/admin/permission/delete', 'com.choxsu.admin.permission.PermissionAdminController', '权限删除');
INSERT INTO `permission` VALUES (192, '/admin/permission/edit', 'com.choxsu.admin.permission.PermissionAdminController', '权限编辑页面');
INSERT INTO `permission` VALUES (193, '/admin/permission/sync', 'com.choxsu.admin.permission.PermissionAdminController', '权限同步');
INSERT INTO `permission` VALUES (194, '/admin/permission/update', 'com.choxsu.admin.permission.PermissionAdminController', '权限更新');
INSERT INTO `permission` VALUES (195, '/admin/quartz', 'com.choxsu.admin.quartz.JobManageController', '定时任务管理首页');
INSERT INTO `permission` VALUES (196, '/admin/quartz/add', 'com.choxsu.admin.quartz.JobManageController', '定时任务添加页面');
INSERT INTO `permission` VALUES (197, '/admin/quartz/delete', 'com.choxsu.admin.quartz.JobManageController', '定时任务删除');
INSERT INTO `permission` VALUES (198, '/admin/quartz/edit', 'com.choxsu.admin.quartz.JobManageController', '定时任务编辑页面');
INSERT INTO `permission` VALUES (199, '/admin/quartz/get', 'com.choxsu.admin.quartz.JobManageController', '定时任务详情');
INSERT INTO `permission` VALUES (200, '/admin/quartz/save', 'com.choxsu.admin.quartz.JobManageController', '定时任务保存');
INSERT INTO `permission` VALUES (201, '/admin/quartz/start', 'com.choxsu.admin.quartz.JobManageController', '定时任务开始');
INSERT INTO `permission` VALUES (202, '/admin/quartz/update', 'com.choxsu.admin.quartz.JobManageController', '定时任务更新');
INSERT INTO `permission` VALUES (203, '/admin/reply', 'com.choxsu.admin.reply.ReplyController', '评论列表首页');
INSERT INTO `permission` VALUES (204, '/admin/role', 'com.choxsu.admin.role.RoleAdminController', '角色管理首页');
INSERT INTO `permission` VALUES (205, '/admin/role/add', 'com.choxsu.admin.role.RoleAdminController', '角色添加页面');
INSERT INTO `permission` VALUES (206, '/admin/role/addPermission', 'com.choxsu.admin.role.RoleAdminController', '角色权限增加');
INSERT INTO `permission` VALUES (207, '/admin/role/assignPermissions', 'com.choxsu.admin.role.RoleAdminController', '角色分配权限页面');
INSERT INTO `permission` VALUES (208, '/admin/role/delete', 'com.choxsu.admin.role.RoleAdminController', '角色删除');
INSERT INTO `permission` VALUES (209, '/admin/role/deletePermission', 'com.choxsu.admin.role.RoleAdminController', '角色权限删除');
INSERT INTO `permission` VALUES (210, '/admin/role/edit', 'com.choxsu.admin.role.RoleAdminController', '角色编辑页面');
INSERT INTO `permission` VALUES (211, '/admin/role/save', 'com.choxsu.admin.role.RoleAdminController', '角色保存');
INSERT INTO `permission` VALUES (212, '/admin/role/update', 'com.choxsu.admin.role.RoleAdminController', '角色更新');
INSERT INTO `permission` VALUES (213, '/admin/sensitiveWord', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字管理首页');
INSERT INTO `permission` VALUES (214, '/admin/sensitiveWord/add', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字添加页面');
INSERT INTO `permission` VALUES (215, '/admin/sensitiveWord/delete', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字删除');
INSERT INTO `permission` VALUES (216, '/admin/sensitiveWord/edit', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字编辑页面');
INSERT INTO `permission` VALUES (217, '/admin/sensitiveWord/exchange', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字汉字转换拼音');
INSERT INTO `permission` VALUES (218, '/admin/sensitiveWord/save', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字保存');
INSERT INTO `permission` VALUES (219, '/admin/sensitiveWord/update', 'com.choxsu.admin.sensitive_word.SensitiveWordAdminController', '敏感字更新');
INSERT INTO `permission` VALUES (220, '/admin/tag', 'com.choxsu.admin.tag.AdminTagController', '标签管理首页');
INSERT INTO `permission` VALUES (221, '/admin/tag/add', 'com.choxsu.admin.tag.AdminTagController', '标签添加页面');
INSERT INTO `permission` VALUES (222, '/admin/tag/delete', 'com.choxsu.admin.tag.AdminTagController', '标签删除');
INSERT INTO `permission` VALUES (223, '/admin/tag/edit', 'com.choxsu.admin.tag.AdminTagController', '标签编辑页面');
INSERT INTO `permission` VALUES (224, '/admin/tag/save', 'com.choxsu.admin.tag.AdminTagController', '标签保存');
INSERT INTO `permission` VALUES (225, '/admin/tag/update', 'com.choxsu.admin.tag.AdminTagController', '标签更新');
...
INSERT INTO `permission` VALUES (228, '/admin/uploadLog', 'com.choxsu.admin.account.AccountAdminController', '图片上传日志记录首页');
INSERT INTO `permission` VALUES (229, '/admin/visitor', 'com.choxsu.admin.visitor.VisitorAdminController', 'PV管理首页');
